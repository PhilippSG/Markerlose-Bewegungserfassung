...
\def\hlmint{\fontfamily{lmss}\fontsize{19pt}{19pt}\fontseries{bx}\color{fh-mint}\selectfont}
\def\hlAbold{\fontfamily{lmss}\fontsize{14pt}{30pt}\fontseries{bx}\selectfont}
    ...
    \begin{titlepage}
        ...
        \begin{center}
            ...
            \begin{tabularx}{\textwidth}{ X  X  }
                Prüferin:        & \l__titlepage_examiner_tl        \\[1em]
            \end{tabularx}
        \end{center}
