...
\begin{itemize}
    \item \texttt{arm\_model} -- Ein auf dem Standard-Modell arm26 \cite{opensim_models} von OpenSim aufbauendes Modell,
    welches sich nur auf den rechten Arm konzentriert. Das Modell befindet sich im GitHub-Repository \cite{github_repository}
    unter \url{OpenSim/models/arm\_model.osim}.
