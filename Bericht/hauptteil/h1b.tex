...
Eine Funktion bekommt dann jeweils die x-,y- und z- Koordinaten eines Keypoints von MediaPipe BlazePose und schreibt sie im CSV Format
mit den jeweils zugehörigen Frames und der dementsprechenden Zeit in eine Datei.
...
Eine weitere Funktion in unserem Workflow erstellt aus den Positionsdaten in der CSV Datei nun eine Marker Datei,
welche wir in OpenSim verwenden können. Wichtig dabei ist dass unsere drei verwendeten Keypoints aus Mediapipe BlazePose
...
Jede Art von Marker Datei kann man in OpenSim darstellen unter "Preview experimental Data" um die Marker visualisiert im Raum zu sehen.
Als letzten Schritt verwenden wir die Marker Dateien im Inversen Kinematik Tool \cite{opensim_ik} von OpenSim um eine .mot
Bewegungsdatei zu bekommen welche die Gelenkwinkel des Modells beinhaltet.
