...
\subsection{Verwendung des pose2sim_cli.py}
...
\begin{figure}[H] 
    \centering
    \includegraphics[width=0.48\textwidth]{Bericht/img/Kamera_Setup.jpeg}
    \hfill
    \includegraphics[width=0.48\textwidth]{Bericht/img/Cali_intrinsics.png}
    
    % Gemeinsame Bildunterschrift
    \caption{Links: Exemplarischer Aufbau des Kamera-Setups mit Schachbrettmuster. Rechts: Beispielhafte Darstellung der intrinsischen Kalibrierungsergebnisse.}
    \label{fig:kalibrierung_visuell} % Ein neuer, passenderer Label-Name
\end{figure}
