...
\begin{figure}[H]
    ...
    \caption{Experimentelle und virtuelle Marker}
...
\begin{figure}[H]
    ...
    \caption{Least Square Problem der IK (kleinstes Fehlerquadrat)}
...
Um vergleichbare Ergebnisse zu erhalten, müssen die Koordinatengewichte entsprechend an die verwendetetn Winkeleinheiten angepasst werden. \cite{opensim_ik}
