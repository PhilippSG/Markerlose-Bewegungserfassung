...
haben wir uns entschieden, ein identisches
OpenSim-Modell\cite{opensim_arm_model} zu verwenden.
...
Die verwendeten Dateien\cite{mp_p2s_files_comp}, die
Originalvideos sowie ein Ergebnisvideo\cite{mp_p2s_video_comp},
welches die Eingabevideos gemeinsam mit dem entsprechenden
OpenSim-Ergebnis darstellt sind im GitHub-Repository wiederzufinden.
...
dass die MediaPipe Markerfehler immer dann ansteigen, wenn die Pose2Sim Fehler leicht
